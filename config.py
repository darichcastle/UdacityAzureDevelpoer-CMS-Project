...
class Config(object):
    ...
    SQL_DATABASE = os.environ.get('SQL_DATABASE') or 'udacity-nd-cms-db'
    ...
    CLIENT_SECRET = "~6kN.Y6K5YDYopeuH1HI~2yVbAd8t1_-6W"
    ...
    CLIENT_ID = "1740f3aa-5c0f-481c-8e12-52689c6c98d3"
